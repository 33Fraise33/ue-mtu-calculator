...
function App() {
  ...
  return (
    <main className="shell">
      ...
      <footer><span>UE MTU Calculator - Transport Overhead</span><div className="footer-meta"><span>Calculations run locally in your browser</span><span>Created by <a href="https://unitix.be" rel="noreferrer">Unitix</a> (2026)</span></div></footer>
    </main>
  );
}
